	...
	<article class="fluxi-content wrap-n">
        ...
        <form class="cmxform" action="" method="post" name="soumettre_projet" id="soumettre_projet" enctype="multipart/form-data">
          <fieldset id="form-part-1">
            <legend class="big-section">Le projet en bref</legend>
            <p>
          ...
          <fieldset id="form-part-2">
            <legend class="big-section">Personne contact du projet</legend>
            <p>
            ...
            <p><label for="connu_comment">Comment avez-vous connu Energie Partagée ?<abbr class="require-form" title="obligatoire">*</abbr></label>
              ...
              <label for="connu_rad_5" class="block">
                ...
                Interventions publiques</label>
              <label for="connu_rad_6" class="block">
                <input name="connu_comment" type="radio" value="Autres" id="connu_rad_6" >
                Autres</label>
              <input class="sub-hide-item" name="connu_autre" type="text" placeholder="Si Autres, précisez" value="<?php if(!empty($_SESSION['connu_autres'])) echo $_SESSION['connu_autres']; ?>" id="connu_autre" >
              <label for="connu_comment" class="error">Veuillez sélectionner une réponse.</label>
            </p>
            <p><label for="collectif">Représentez-vous un collectif, une association, une société de projet pour ce projet ?<abbr class="require-form" title="obligatoire">*</abbr></label>
              ...
              <label for="collectif_3" class="block">
                ...
                Société de projet</label>
              <label for="collectif_4" class="block">
                <input name="collectif" type="radio" value="Autres" id="collectif_4" />
                Autres</label>
              <input class="sub-hide-item" id="autre_collectif" name="autre_collectif" type="text" placeholder="Si autres, précisez" value="<?php if(!empty($_SESSION['autre_collectif'])) echo $_SESSION['autre_collectif']; ?>" >
              ...
              <label for="collectif" class="error">Veuillez sélectionner une réponse.</label>
            </p>
          </fieldset>
          <fieldset id="form-part-3">
            <legend class="big-section">Détails du projet</legend>
            <h4>Contexte local</h4>
            <p>
            ...
            <p class="hide-item item-1-6"><label for="entite_porteuse">Y a t-il une entité porteuse du projet ?<abbr class="require-form" title="obligatoire">*</abbr></label>
              ...
              <label for="entite_porteuse" class="error">Veuillez sélectionner une réponse.</label>
            </p>
            ...
            <h4 class="hide-item item-1-6">Production</h4>
            ...
            <h4 class="hide-item item-1-5">Etat d’avancement</h4>
            ...
            <p class="hide-item item-1-5"><label for="projet_formalise">Avez-vous déjà formalisé un projet détaillé ?<abbr class="require-form" title="obligatoire">*</abbr></label>
              ...
              <label for="projet_formalise" class="error">Veuillez sélectionner une réponse.</label>
            </p>
          ...
          <fieldset id="form-part-4" class="hide-item item-1-6">
            <legend class="big-section">Principes du projet</legend>
            <div class="hide-item item-1-6">
              <h4 class="hide-item item-1-6">Ancrage collectif et local</h4>
              <p class="hide-item item-1-6">
              ...
              <h4 class="hide-item item-1-6">Non spéculation</h4>
              <p class="hide-item item-1-6">
              ...
              <p class="hide-item item-1-6"><label for="actions_sensibilisation">Des actions de sensibilisation sont-elles prévues en marge du projet ?<abbr class="require-form" title="obligatoire">*</abbr></label>
                ...
                <label for="actions_sensibilisation_2" class="block">
                  ...
                  Oui</label>
                <textarea class="sub-hide-item" name="actions_sensibilisation_detail" id="actions_sensibilisation_detail" placeholder="Les décrire :" disabled><?php if(!empty($_SESSION['actions_sensibilisation'])) echo $_SESSION['actions_sensibilisation']; ?></textarea>
                <label for="actions_sensibilisation" class="error">Veuillez sélectionner une réponse.</label>
              </p>
              <h4 class="hide-item item-2-6">Démocratie et transparence</h4>
              <p class="hide-item item-2-6"><label for="dispositions_securisant">Existe-t-il des dispositions sécurisant une gouvernance locale et citoyenne dans les statuts de la société d'exploitation ?<abbr class="require-form" title="obligatoire">*</abbr></label>
                ...
                <label for="dispositions_securisant" class="error">Veuillez sélectionner une réponse.</label>
              </p>
            </div>
          </fieldset>
          <fieldset id="form-part-5" class="hide-item item-2-6">
            <legend class="big-section">Investissement</legend>
            <div class="hide-item item-2-6">
              ...
              <p class="hide-item item-2-6"><label for="demande_financement">Souhaitez-vous faire une demande de financement à Energie Partagée Investissement ?<abbr class="require-form" title="obligatoire">*</abbr></label>
                ...
                <label for="demande_financement_2" class="block">
                  ...
                  Oui</label>
                <label for="montant_financement" class="sub-hide-item" id="montant_financement_label">Quel montant souhaitez-vous demander à EPI ?</label>
                <input class="sub-hide-item" name="montant_financement" id="montant_financement" type="text" placeholder="(min : 50 000 € / max 500 000 euros) (en €)" value="<?php if(!empty($_SESSION['montant_demande_financement'])) echo $_SESSION['montant_demande_financement']; ?>" disabled>
                <label for="montant_financement" class="error">Veuillez sélectionner une réponse.</label>
              </p>
              <p class="hide-item item-2-6">
          ...
          <fieldset id="form-part-6">
            <legend class="big-section">Informations complémentaires</legend>
            <h4 class="hide-item item-1-3">Accompagnement et déroulement</h4>
          ...
          <p>
            ...
            <p><label for="projet_visible">Autorisez-vous à rendre publique votre fiche projet ?<abbr class="require-form" title="obligatoire">*</abbr></label>
              ...
              <label for="projet_visible_2" class="block">
                ...
                Oui</label>
              <label for="projet_visible" class="error">Veuillez sélectionner une réponse.</label>
            </p>
          </fieldset>
          ...
          <div class="btns-form">
            ...
            <input type="submit" value="Envoyer" id="submit" name="submit" class="m-bt-in-soumettre-form">            
          </div>
        </form>
